(function attachFeelingLanguageBridge(global) {
    ...
    const SEED_CASES = Object.freeze([
        ...
        Object.freeze({
            id: 'body',
            label: 'בריאות',
            title: 'הגוף שלי בוגד בי',
            originalSentence: 'הגוף שלי בוגד בי',
            hotPhrases: Object.freeze(['בוגד בי', 'הגוף שלי', 'בוגד']),
            outerSuggestions: Object.freeze([
                'פעמיים בחודש האחרון התעוררתי עייף גם אחרי שינה מלאה.',
                'באמצע ההליכה אתמול הברך כאבה ועצרתי אחרי עשר דקות.',
                'בבדיקות האחרונות יצא ערך אחד גבולי, והשאר היו תקינים.'
            ]),
            innerSuggestions: Object.freeze([
                'עולה בי פחד שאני מאבד שליטה על משהו בסיסי.',
                'אני מרגיש אכזבה, כאילו חתמתי על חוזה שהופר.',
                'בבטן יש כיווץ של חוסר ודאות.'
            ]),
            innerTags: Object.freeze(['פחד', 'אכזבה', 'אובדן שליטה']),
            innerImages: Object.freeze(['כאילו הרכב שלי נוסע בלי הגה', 'כאילו שותף ותיק הפסיק לדבר איתי']),
            defaultZone: 'solar'
        }),
        Object.freeze({
            id: 'study',
            label: 'לימודים',
            title: 'הראש שלי לא בנוי ללימודים',
            originalSentence: 'הראש שלי לא בנוי ללימודים',
            hotPhrases: Object.freeze(['לא בנוי ללימודים', 'הראש שלי', 'לא בנוי']),
            outerSuggestions: Object.freeze([
                'אתמול קראתי שלושה עמודים ובדקתי את הטלפון ארבע פעמים.',
                'במבחן האחרון הצלחתי דווקא בשאלות שתרגלתי בכתב.',
                'כשחבר הסביר לי בקול, הבנתי את החומר מהר יותר מאשר לבד.'
            ]),
            innerSuggestions: Object.freeze([
                'עולה בי ייאוש עוד לפני שפתחתי את החומר.',
                'אני מרגיש טיפש ליד אחרים שנראה שזה קל להם.',
                'בראש נהיה עומס וערפול כשהדפים מצטברים.'
            ]),
            innerTags: Object.freeze(['ייאוש', 'בושה', 'השוואה']),
            innerImages: Object.freeze(['כאילו כולם קיבלו מדריך ואני לא', 'כאילו אני דוחף דלת שכתוב עליה משוך']),
            defaultZone: 'head'
        }),
        Object.freeze({
            id: 'money',
            label: 'כסף',
            title: 'אני גרוע עם כסף',
            originalSentence: 'אני גרוע עם כסף',
            hotPhrases: Object.freeze(['גרוע עם כסף', 'גרוע', 'עם כסף']),
            outerSuggestions: Object.freeze([
                'בחודש שעבר חרגתי בקניות אונליין בעיקר בשעות הלילה.',
                'אף פעם לא ישבתי מול פירוט האשראי יותר מחמש דקות.',
                'כשהיה לי יעד חיסכון לטיול, דווקא עמדתי בו עד הסוף.'
            ]),
            innerSuggestions: Object.freeze([
                'עולה בי בושה כשאני נזכר במינוס.',
                'אני נמנע מלהסתכל, כאילו אם לא רואים זה לא קיים.',
                'בחזה יש כובד של מבוגר שלא עומד בתפקיד.'
            ]),
            innerTags: Object.freeze(['בושה', 'הימנעות', 'כובד']),
            innerImages: Object.freeze(['כאילו יש מגירה שאסור לפתוח', 'כאילו אני נוהג עם עיניים עצומות']),
            defaultZone: 'chest'
        }),
        Object.freeze({
            id: 'friends',
            label: 'חברות',
            title: 'אין לי באמת חברים',
            originalSentence: 'אין לי באמת חברים',
            hotPhrases: Object.freeze(['אין לי באמת', 'באמת חברים', 'אין לי']),
            outerSuggestions: Object.freeze([
                'בחודש האחרון יזמתי מפגש אחד, ושני אנשים יזמו איתי.',
                'יש שלושה אנשים שעונים לי תמיד, אבל בשיחות נשארים בקטנות.',
                'במסיבה האחרונה דיברתי עם כולם ובדרך הביתה הרגשתי לבד.'
            ]),
            innerSuggestions: Object.freeze([
                'עולה בי בדידות דווקא כשאני מוקף אנשים.',
                'אני מרגיש שאם אפסיק ליזום, לא יישאר כלום.',
                'בלב יש געגוע למישהו שמכיר אותי באמת.'
            ]),
            innerTags: Object.freeze(['בדידות', 'געגוע', 'ספק']),
            innerImages: Object.freeze(['כאילו אני מאחורי זכוכית במסיבה', 'כאילו כולם קיבלו מקום ואני אורח']),
            defaultZone: 'heart'
        }),
        Object.freeze({
            id: 'compare',
            label: 'השוואה',
            title: 'כולם מתקדמים בחיים חוץ ממני',
            originalSentence: 'כולם מתקדמים בחיים חוץ ממני',
            hotPhrases: Object.freeze(['כולם מתקדמים', 'חוץ ממני', 'כולם']),
            outerSuggestions: Object.freeze([
                'הבוקר ראיתי בפיד שני חברים שהתארסו ואחד שפרסם קידום.',
                'בשנה האחרונה סיימתי קורס והחזרתי חוב, ואף אחד לא ראה את זה בפיד.',
                'אחרי רבע שעה גלילה מצב הרוח שלי צנח, לפני זה הייתי בסדר.'
            ]),
            innerSuggestions: Object.freeze([
                'עולה בי קנאה שמתחלפת מהר בבושה.',
                'אני מרגיש שאני נשאר מאחור במרוץ שאף אחד לא הכריז עליו.',
                'בחזה נהיה צר כשאני גולל.'
            ]),
            innerTags: Object.freeze(['קנאה', 'בושה', 'דחיפות']),
            innerImages: Object.freeze(['כאילו כולם עברו תחנה ואני נשארתי ברציף', 'כאילו יש לוח תוצאות שרק אני רואה']),
            defaultZone: 'chest'
        }),
        Object.freeze({
            id: 'team',
            label: 'ניהול',
            title: 'אי אפשר לסמוך על אף אחד בצוות',
            originalSentence: 'אי אפשר לסמוך על אף אחד בצוות',
            hotPhrases: Object.freeze(['אי אפשר לסמוך', 'על אף אחד', 'לסמוך']),
            outerSuggestions: Object.freeze([
                'בפרויקט האחרון שני אנשים עמדו בזמן ואחד איחר בלי לעדכן.',
                'כשמסרתי משימה בלי לכתוב מה חשוב לי, קיבלתי תוצר שונה ממה שדמיינתי.',
                'את התיקונים אני עושה לבד בערב, בלי להגיד לאף אחד.'
            ]),
            innerSuggestions: Object.freeze([
                'עולה בי מתח כל פעם שמשימה יוצאת מהידיים שלי.',
                'אני מרגיש שאם משהו ייצא בינוני, זה ייפול עליי.',
                'בכתפיים יש עומס של מי שסוחב הכול לבד.'
            ]),
            innerTags: Object.freeze(['מתח', 'עומס', 'אחריות יתר']),
            innerImages: Object.freeze(['כאילו אני היחיד שמחזיק את התקרה', 'כאילו כל מסירה היא הימור']),
            defaultZone: 'arms'
        })
    ]);
