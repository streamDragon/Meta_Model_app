(function attachMetaModelNavMap(global) {
    ...
    var NAV_MAP = Object.freeze({
        ...
        scenarioTrainer: Object.freeze({ type: 'tab', tab: 'scenario-trainer', path: '/feature/scenario-trainer' }),
        scenes: Object.freeze({ type: 'tab', tab: 'scenario-trainer', path: '/feature/scenario-trainer' }),
