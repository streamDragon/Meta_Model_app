...
(function () {
    ...
    var HELP = {
        ...
        'prismlab': {
            title: 'איך עובדת מפת רמות ומטה-מודל?',
            steps: [
                'בחרו הפרת מטה-מודל או מקרה שתרצו לחקור',
                'קראו את המשפט המרכזי וזהו מה מפעיל את המבנה',
                'בנו את שני המגדלים דרך הרמות הלוגיות',
                'זהו איפה נמצא הגרעין, איפה נפתח הסדק ומה הצעד הבא'
            ],
            example: 'משפט: "אם הוא לא מתקשר, סימן שלא אכפת לו" ← בונים A ו-B, רואים את רמת הזהות, ומחפשים איפה נפתח סדק.',
            tip: 'המפה לא אומרת מי צודק. היא עוזרת להבין איך המבנה מחזיק, ואיפה נכון לעבוד.'
        }
    };
