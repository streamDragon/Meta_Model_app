(function initMetaTrainerPlatformContracts(global) {
    ...
    function freezeWrapper(wrapper) {
        return Object.freeze({
            ...wrapper,
            navLinks: freezeSteps(wrapper?.navLinks || []),
            accent: wrapper?.accent ? Object.freeze({ ...wrapper.accent }) : undefined
        });
    }
    ...
    function freezeContract(contract) {
        return Object.freeze({
            ...contract,
            helperSteps: freezeSteps(contract.helperSteps || []),
            processSteps: freezeSteps(contract.processSteps || []),
            settingsGroups: Object.freeze([...(contract.settingsGroups || [])]),
            mobilePriorityOrder: Object.freeze([...(contract.mobilePriorityOrder || [])]),
            wrapper: freezeWrapper(contract.wrapper || {})
        });
    }

    const contracts = Object.freeze({
        classic2: freezeContract({
            id: 'classic2',
            ...
            wrapper: {
                ...
                navLinks: [
                    { href: 'index.html', label: 'חזרה לדף הראשי' },
                    { href: 'classic_classic_trainer.html', label: 'Classic Classic' },
                    { href: 'iceberg_templates_trainer.html', label: 'Iceberg Templates' }
                ],
                accent: {
                    primary: '#1d4ed8',
                    border: '#bfdbfe',
        ...
        'classic-classic': freezeContract({
            id: 'classic-classic',
            ...
            wrapper: {
                ...
                navLinks: [
                    { href: 'index.html', label: 'חזרה לדף הראשי' },
                    { href: 'classic2_trainer.html', label: 'Classic 2' },
                    { href: 'iceberg_templates_trainer.html', label: 'Iceberg Templates' }
                ],
                accent: {
                    primary: '#2563eb',
        ...
        'iceberg-templates': freezeContract({
