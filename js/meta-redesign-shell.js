(function attachMetaRedesignShell(window, document) {
    ...
    Object.assign(FEATURE_META, {
        ...
        'initial-image-vs-deep-structure': {
            ...
            icon: '🖼️', title: 'תמונה ראשונית מול מבנה עומק', badge: 'למטפלים', tone: 'advanced', color: '#6d28d9', soft: '#ede9fe',
            homeDescription: 'כאן מתאמנים על המעבר מפרשנות אוטומטית למבנה עומק — דרך השמטה, עיוות והכללה.',
            description: 'ממשפט קצר לפרשנות מיידית — ומשם להבנה עמוקה יותר. כאן מתאמנים לראות שהתמונה הראשונית היא רק חלק מהסיפור.',
            problem: 'כשאדם אומר משפט, המקשיב בדרך כלל בונה מיד תמונה פנימית של מה שקרה, למה התכוונו, ומה ברור כאן. אבל הרבה פעמים זו רק תמונה ראשונית.',
            entryCards: [
                { kicker: 'מה קורה כאן', title: 'ממשפט אחד לתמונה שלמה', body: 'דרך חקירת השמטה, עיוות והכללה אפשר לחשוף את המבנה הרחב יותר שממנו המשפט הגיע.' },
                { kicker: 'למה זה חשוב', title: 'ההבנה הראשונית לא בהכרח שגויה, אבל חלקית', body: 'מבנה העומק עוזר מצד אחד להבין את ההיגיון של האדם, ומצד שני לראות שזה לא ההיגיון היחיד האפשרי.' },
                { kicker: 'מה מרוויחים', title: 'תמונה מדויקת יותר לפני התערבות', body: 'במקום להגיב לפרשנות הראשונה, מגלים מה עוד מסתתר מתחת לפני השטח — ואז אפשר לבחור התערבות מדויקת יותר.' }
            ],
            successNote: 'הצלחה כאן נראית כמו מעבר מ"ברור לי מה קרה" ל"עכשיו אני מבין מה באמת קורה כאן".',
            example: { sentence: 'הוא הרגיז אותי אז צרחתי עליו', type: 'השמטה + עיוות + הכללה', challenge: 'מה בדיוק קרה, איזה פירוש נכנס, ואיזה כלל פעל מאחורי הקלעים?' },
            ...
            modals: [
                {
                    ...
                    icon: '🧠',
                    label: 'הרעיון',
                    title: 'מה בין תמונה ראשונית למבנה עומק',
                    eyebrow: 'רקע מושגי',
                    lead: 'כשאדם אומר משפט, אנחנו בונים מיד תמונה פנימית שנראית מלאה. אבל היא מבוססת על מה שנאמר, לא על מה שקרה.',
                ...
                },
                {
                    ...
                    eyebrow: 'סדר עבודה',
                    lead: 'בכל תרגול יש משפט מקור, תשע חשיפות, ותמונה שמשתנה בהדרגה.',
                    sectionTitle: 'מה עושים בפועל',
                    paragraphs: [
                        'לוחצים על אחד משלושת הכפתורים: השמטה, עיוות, הכללה.',
                        'כל לחיצה חושפת טקסט חדש סביב המשפט המקורי, ומשנה חלק מהתמונה.',
                        'בסוף — כשכל תשע החשיפות מולאו — רואים תמונה חדשה והבנה רחבה יותר.'
                    ],
                    tipTitle: 'טיפ',
                    tip: 'אין סדר חובה. אפשר להתחיל מכל כפתור. הנקודה היא לראות איך כל חשיפה משנה את ההבנה.'
                }
            ],
            settings: {}
        },
