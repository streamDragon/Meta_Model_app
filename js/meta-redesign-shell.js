(function attachMetaRedesignShell(window, document) {
    ...
    Object.assign(FEATURE_META, {
        ...
        prismlab: {
            ...
            description: 'כאן בונים מפת הכרח מלאה: שתי עמודות, 12 חוליות על פני הרמות הלוגיות, ואז מעבר לשיח ממוקד על גרעין, סדק ושאלת פאנץ׳.',
            entryCards: [
                ...
                { kicker: 'מה קורה אחרי המפה', title: 'הטבלה זזה לרקע והשיח עולה למרכז', body: 'בסיום הבנייה עוברים למסך שיחה בסגנון הודעות, שבו עובדים על השיקוף, הגרעין, הסדק ושאלת הפאנץ׳. המפה נשארת זמינה דרך כפתור overlay.' },
            ...
            modals: [
                {
                    ...
                    eyebrow: 'מסלול עבודה',
                    lead: 'המסלול בנוי כמו מעבר ממפה מלאה לשיח ממוקד: קודם בונים את המבנה, אחר כך קוראים אותו כמו שיחה טיפולית.',
                    ...
                    cards: [
                        ...
                        { kicker: '4. שיח', title: 'עוברים למסך הודעות ממוקד', body: 'הטבלה יורדת ל־overlay, והשיחה עצמה מתמקדת בגרעין, בסדק ובשאלת הפאנץ׳.' },
                ...
                },
                {
                    ...
                    paragraphs: [
                        ...
                        'בשלב השיח הטבלה עצמה כבר לא חייבת להישאר פתוחה. המבנה שלה נשאר מאחורי הקלעים, והמסך עובד עם התוצאה: גרעין, סדק ופאנץ׳.'
                    ],
