(function attachMetaRedesignShell(window, document) {
    ...
    function homeCinematicHero() {
        return [
            ...
            '<p class="hhc-subtitle">אנחנו לא שומעים רק מילים. אנחנו משלימים חורים, מדמיינים כוונה, קופצים למסקנות, ומפרשים לפי הרגש, ההקשר, והסיפור שכבר חי בתוכנו.</p>',
            ...
            '</article>',<p class="hhc-subtitle">כאן תקבלו את שער הכניסה המעשי למטה\u2011מודל: קודם להבין למה זה חשוב — ואז ללמוד לזהות את הדפוסים עצמם בבהירות.</p>',
            '</div>',
