(function attachMetaRedesignShell(window, document) {
    ...
    Object.assign(FEATURE_META, {
        ...
        prismlab: {
            ...
            icon: '🔮', title: 'מעבדת רמות לוגיות', badge: 'עומק', tone: 'advanced', color: '#2563eb', soft: '#e7f0ff',
            ...
            modals: [
                {
                    ...
                    icon: '🪜',
                    label: 'סדר עבודה',
                    title: 'סדר העבודה במעבדת הרמות הלוגיות',
                    eyebrow: 'מסלול עבודה',
    ...
    FEATURE_META['practice-verb-unzip'].description = 'זה דף קבלת הפנים של ארגז הכלים: מבינים מה יש בפנים, איך לבחור נכון, ואז נכנסים למסך הכלים עצמו.';
    FEATURE_META['practice-verb-unzip'].problem = 'כשכל הכלים יושבים באותו מקום, קל להתחיל לקרוא הכול או לפתוח כמה מסלולים יחד. כאן קודם עושים סדר, ורק אחר כך נכנסים.';
    FEATURE_META['practice-verb-unzip'].entryCards = [
        { kicker: 'מה זה בכלל', title: 'שער הכניסה לכל ארגז הכלים', body: 'זה לא כלי אחד אלא ספריית עבודה מסודרת: תרגול, ניתוח, סימולציה, למידה וכלי מטפל.' },
        { kicker: 'איך משתמשים כאן', title: 'קודם בוחרים משפחה, ואז כלי אחד', body: 'הדף הזה נועד לעשות סדר. בוחרים את סוג העבודה, נכנסים לכלי אחד, ורק אחר כך מחליטים אם צריך מעבר נוסף.' },
        { kicker: 'מה מחכה בפנים', title: 'כמה מסלולים, אותו קו עבודה', body: 'יש כלים פנימיים, דפים נפרדים, ומסלולים עמוקים יותר. כולם מאורגנים עכשיו לפי משפחות ולא לפי עומס כפתורים.' }
    ];
    FEATURE_META['practice-verb-unzip'].successNote = 'הצלחה כאן נראית כמו בחירה נקייה בכלי הנכון, בלי לקרוא שוב את כל ההסברים בתוך דף הכלים.';
    FEATURE_META['practice-verb-unzip'].ctaLabel = 'כניסה לדף הכלים';
    FEATURE_META['practice-verb-unzip'].modals = [
        {
            id: 'what-is',
            icon: '🗂',
            label: 'מה זה',
            title: 'מהו ארגז הכלים',
            eyebrow: 'דף קבלת הפנים',
            lead: 'מרכז כלים הוא שער ניווט. לא נשארים בו לעבוד, אלא משתמשים בו כדי לבחור את התחנה הבאה בצורה ברורה.',
            cardsTitle: 'חמש המשפחות שבפנים',
            cards: [
                { kicker: 'Practice', title: 'תרגול', body: 'מסלולים לחזרתיות, זיהוי מהיר, עבודה עם ברין וכניסה לאימונים קלאסיים.' },
                { kicker: 'Analysis', title: 'ניתוח', body: 'כלים שמפרקים ניסוח עמום למפה ברורה: משפט, פועל, פריזמות וקצה הקרחון.' },
                { kicker: 'Simulation', title: 'סימולציה', body: 'מסכים שבודקים איך שפה נוחתת בשיחה חיה ולא רק אם היא נשמעת נכונה.' },
                { kicker: 'Learning', title: 'למידה', body: 'כלים להלימה, שפה מקצועית, מונחים ויסודות שמחזיקים את שאר המסלולים.' },
                { kicker: 'Therapist Tools', title: 'כלי מטפל', body: 'מסלולי עומק לבניית מהלך, בחירת כיוון עבודה ובדיקת שכבה טיפולית.' }
            ],
            tipTitle: 'העיקרון של המסך הזה',
            tip: 'במקום רשימת כפתורים אחת גדולה, בוחרים קודם משפחה ורק אחר כך כלי אחד מתאים.'
        },
        {
            id: 'how-to-use',
            icon: '⚙',
            label: 'איך משתמשים',
            title: 'איך משתמשים בארגז הכלים בלי עומס',
            eyebrow: 'סדר עבודה מומלץ',
            lead: 'המטרה היא לא לקרוא הכול בכל פעם מחדש, אלא להבין מהו סוג העבודה שצריך עכשיו ולהיכנס מהר.',
            sectionTitle: 'המלצת פתיחה',
            paragraphs: [
                'אם צריך זיהוי מהיר או חזרתיות: התחילו מתרגול.',
                'אם צריך לפרק משפט, פועל או מבנה: עברו לניתוח.',
                'אם צריך לראות איך שפה נוחתת בשיחה: עברו לסימולציה.',
                'אם צריך מהלך, שכבה או כיוון קליני: היכנסו לכלי המטפל.'
            ],
            tipTitle: 'מה חשוב לזכור',
            tip: 'דף קבלת הפנים מסביר. דף הכלים עצמו צריך להישאר קצר, נקי ומהיר לכניסה.'
        }
    ];
    ...
    function homeCinematicHero() {
        return [
            ...
            '</div>',
            '<div class="hhc-copy">',
            '<div class="hhc-badge"><span class="hhc-badge-dot"></span>NLP · Meta Model · המדריך המעשי למטפלים</div>',
            '<h2 class="hhc-title">לשמוע משפט —<br><span class="hhc-title-accent">ולראות מה מסתתר בתוכו</span></h2>',
            '<article class="meta-home-entry-card meta-home-entry-card--knowledge" style="--meta-feature-accent:#0f766e;--meta-feature-soft:#dcfce7;">',
            '<div class="meta-home-entry-card__head"><span class="meta-home-entry-card__badge" data-tone="knowledge">\u05d9\u05d3\u05e2 \u05d1\u05e1\u05d9\u05e1\u05d9</span><span class="meta-home-entry-card__step">\u05dc\u05de\u05d9 \u05e9\u05e6\u05e8\u05d9\u05da \u05e8\u05e7\u05e2</span></div>',
            '<h3>\u05d4\u05d0\u05e0\u05d9\u05e4\u05e7\u05e4\u05dc\u05d5\u05e4\u05d3\u05d9\u05d4 \u05e9\u05dc \u05d4\u05de\u05d8\u05d4 \u05de\u05d5\u05d3\u05dc</h3>',
            '<p class="meta-home-entry-card__subtitle">\u05db\u05dc \u05d4\u05e7\u05d8\u05d2\u05d5\u05e8\u05d9\u05d5\u05ea, \u05d4\u05de\u05d5\u05e0\u05d7\u05d9\u05dd \u05d5\u05d4\u05d3\u05d5\u05d2\u05de\u05d0\u05d5\u05ea \u05d1\u05de\u05e7\u05d5\u05dd \u05d0\u05d7\u05d3</p>',
            '<p>\u05d0\u05dd \u05d7\u05e1\u05e8 \u05dc\u05db\u05dd \u05d1\u05e1\u05d9\u05e1, \u05de\u05ea\u05d7\u05d9\u05dc\u05d9\u05dd \u05db\u05d0\u05df. \u05e4\u05d5\u05ea\u05d7\u05d9\u05dd \u05d0\u05ea \u05d4\u05d0\u05e0\u05e6\u05d9\u05e7\u05dc\u05d5\u05e4\u05d3\u05d9\u05d4, \u05d1\u05d5\u05d7\u05e8\u05d9\u05dd \u05e7\u05d8\u05d2\u05d5\u05e8\u05d9\u05d4, \u05d5\u05e8\u05e7 \u05d0\u05d7\u05e8 \u05db\u05da \u05d7\u05d5\u05d6\u05e8\u05d9\u05dd \u05dc\u05ea\u05e8\u05d2\u05d5\u05dc.</p>',
            '<button type="button" class="btn btn-primary meta-home-entry-card__cta" data-open-feature="categories">\u05e4\u05ea\u05d7\u05d5 \u05d0\u05e0\u05e6\u05d9\u05e7\u05dc\u05d5\u05e4\u05d3\u05d9\u05d4</button>',
            '</article>',
            '<p class="hhc-subtitle">אנחנו לא רק שומעים מילים. אנחנו מזהים מה הושמט, מה הושלם, ואיך המשמעות נבנית.</p>',
            '<p class="hhc-subtitle">\u05db\u05d0\u05df \u05e0\u05db\u05e0\u05e1\u05d9\u05dd \u05de\u05e1\u05d5\u05d3\u05e8: \u05e7\u05d5\u05d3\u05dd \u05de\u05d1\u05d9\u05e0\u05d9\u05dd \u05dc\u05de\u05d4 \u05d6\u05d4 \u05d7\u05e9\u05d5\u05d1, \u05d5\u05d0\u05d6 \u05de\u05d6\u05d4\u05d9\u05dd \u05d0\u05ea \u05d4\u05d3\u05e4\u05d5\u05e1\u05d9\u05dd \u05e2\u05e6\u05de\u05dd \u05d1\u05d1\u05d9\u05e8\u05d5\u05e8\u05d5\u05ea.</p>',
            '</div>',
    ...
    function homeEntryGate() {
        ...
        return [
            ...
            '</article>',
            '<div class="meta-home-shell__quick-actions" aria-label="פעולות מהירות">',
            '<button type="button" class="btn btn-secondary meta-home-shell__quick-action" data-open-feature="practice-question">תרגול זיהוי</button>',
            '<button type="button" class="btn btn-secondary meta-home-shell__quick-action" data-open-feature="categories">אנציקלופדיה</button>',
            '</div>',
