(function attachMetaRedesignShell(window, document) {
    ...
    function homeCinematicHero() {
        return [
            ...
            '<p class="hhc-subtitle">המטה\u2011מודל עוזר למטפל לעצור את ההשלמה האוטומטית, להישאר עם האדם שמולו, ולזהות מה הושמט, איזה פירוש נכנס, ואיזה חוק פנימי התחיל לעבוד.</p>',
            '<p class="hhc-subtitle">כאן תקבלו את שער הכניסה המעשי למטה\u2011מודל: קודם להבין למה זה חשוב — ואז ללמוד לזהות את הדפוסים עצמם בבהירות.</p>',
            '</div>',
