...
const reviewRoutes: MobileReviewRoute[] = [
  {
    ...
    tab: 'home',
    headingSelectors: [
      '.meta-home-entry-card h3',
      '.meta-home-shell__hero h2',
      '.meta-home-shell__brand strong',
      'article h2',
      '#app-sticky-current-title',
      'header h1',
      '#home .mobile-feed-launchpad-title',
    ],
    mainSelectors: [
      '.meta-home-shell__entry-gate',
      '.meta-home-entry-card',
      'article[aria-label]',
      '#home article',
      '#home .product-family-card',
      '#mobile-feed-home:not([hidden])',
    ],
    primarySelectors: ['.meta-home-entry-card__cta', 'article button', '#home .product-tool-entry', '#home button'],
  },
  {
    id: 'categories',
